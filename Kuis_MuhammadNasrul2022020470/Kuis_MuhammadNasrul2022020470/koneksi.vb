...
Public Class koneksi
    ...
    Public Function openconn() As Boolean
        koneksi = New OleDbConnection("provider=Microsoft.ACE.OLEDB.12.0;data source=D:\KULIAH\SEMESTER 3\VB\KUIS2\DB_MuhammadNasrul2022020470.accdb;Persist Security Info=False")
